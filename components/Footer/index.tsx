          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-8 max-w-[360px] lg:mb-10">
                ...
                <p className="font-large mb-9 mt-0 text-base font-bold leading-relaxed text-body-color dark:text-body-color-dark ">
                ...
                <div className="flex space-x-7">
                  ...
                  >
                    <svg
                      ...
                      height="32"
                      viewBox="0 0 24 24"
                      className="hover:text-secondary dark:hover:text-secondary fill-current text-primary duration-300 dark:text-primary"
                    >
            ...
            <div className="same-line-container">
              <div className="w-full px-2 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div className="mb-12 ml-0 lg:mb-16">
                  <h2 className="mb-6 text-xl font-bold text-black hover:underline dark:text-white">
                    Imp Links
                  </h2>
                  <ul>
                    <li>
                      <a href="https://push.org/" className="link">
                        Push Protocol
                      </a>
                    </li>
                    <li>
                      <a href="https://ipfs.tech/" className="link">
                        IPFS
                      </a>
                    </li>
                    <li>
